...
class PHPGit_Repository
{
    ...
    protected static $defaultOptions = array(
        'command_class'   => 'Lib\Ext\PHPGit\PHPGit_Command', // class used to create a command
...
class InvalidGitRepositoryDirectoryException extends \ArException
{
}
